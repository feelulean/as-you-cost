 ...
 * - Mapper XML namespace: smartsuite.app.bp.cost.targetcost.TargetCostGuideRepository
 */
@Service
public class TargetCostGuideRepository {

    private static final String NAMESPACE = "smartsuite.app.bp.cost.targetcost.TargetCostGuideRepository.";
