 ...
 * - Mapper XML namespace: smartsuite.app.bp.cost.targetcost.TargetCostRepository
 */
@Service
public class TargetCostRepository {

    private static final String NAMESPACE = "smartsuite.app.bp.cost.targetcost.TargetCostRepository.";
