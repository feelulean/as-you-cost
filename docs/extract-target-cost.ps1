...
$zip = [System.IO.Compression.ZipFile]::OpenRead('c:\Users\egrou\as-you-cost\docs\target-cost-manual.pptx')
...
$zip.Dispose()
$result | Out-File -FilePath 'c:\Users\egrou\as-you-cost\docs\target-cost-manual.txt' -Encoding UTF8
Write-Host "Extracted to target-cost-manual.txt"
